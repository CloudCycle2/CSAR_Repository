...
public class WineryListResource {

	private static final Logger LOGGER = LogManager.getLogger(WineryListResource.class);

	UriInfo uriInfo;

	public WineryListResource(UriInfo uriInfo) {
